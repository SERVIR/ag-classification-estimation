...
var classifier2019 = baseModule.model.randomForest(training_sample, bands, finalImagery, label, parameters2020_1);
...
labels_2019 = labels_2019.map(function(f) {
  ...
  var el = elevation.sampleRegions({
    collection: ee.FeatureCollection([geometry]),
    scale: 30
  });
  f = f.setGeometry(geometry);
  f = f.set('elevation', el.first().get('elevation'));
  return f;
});
...
var validationSample2019 = rice2019.sampleRegions({
  ...
  properties: [property, 'elevation'],
  scale: 30,
  geometries: true,
});

Map.addLayer(validationSample2019, {}, 'samples2019');
...
print('##########################################');
print('upland validation');
print('##########################################');

// var uplandSample2019 = validationSample2019.filter(ee.Filter.and(ee.Filter.gte('elevation', 700), ee.Filter.lt('elevation', 1600)));
var uplandSample2019 = validationSample2019.filter(ee.Filter.and(ee.Filter.gte('elevation', 700), ee.Filter.lt('elevation', 2500)));
print('uplandSample2019', uplandSample2019);

Map.addLayer(uplandSample2019, {}, 'uplandSample2019');

var uplandConfusionMatrix2019 = uplandSample2019.errorMatrix(property, 'classification');
print('uplandConfusionMatrix2019', uplandConfusionMatrix2019);
print('uplandAccuracy2019', uplandConfusionMatrix2019.accuracy());
print('uplandConsumersAccuracy2019 (Precision)', uplandConfusionMatrix2019.consumersAccuracy().get([0, 1]));
print('uplandProducersAccuracy2019 (Recall)', uplandConfusionMatrix2019.producersAccuracy().get([1, 0]));
print('uplandFscore2019', uplandConfusionMatrix2019.fscore().get([1]));
print('uplandKappa2019', uplandConfusionMatrix2019.kappa());

print('##########################################');
print('lowland validation');
print('##########################################');

// var lowlandSample2019 = validationSample2019.filter(ee.Filter.and(ee.Filter.gte('elevation', 200), ee.Filter.lt('elevation', 700)));
var lowlandSample2019 = validationSample2019.filter(ee.Filter.and(ee.Filter.gte('elevation', 0), ee.Filter.lt('elevation', 700)));
print('lowlandSample2019', lowlandSample2019);

Map.addLayer(lowlandSample2019, {}, 'lowlandSample2019');

var lowlandConfusionMatrix2019 = lowlandSample2019.errorMatrix(property, 'classification');
print('lowlandConfusionMatrix2019', lowlandConfusionMatrix2019);
print('lowlandAccuracy2019', lowlandConfusionMatrix2019.accuracy());
print('lowlandConsumersAccuracy2019 (Precision)', lowlandConfusionMatrix2019.consumersAccuracy().get([0, 1]));
print('lowlandProducersAccuracy2019 (Recall)', lowlandConfusionMatrix2019.producersAccuracy().get([1, 0]));
print('lowlandFscore2019', lowlandConfusionMatrix2019.fscore().get([1]));
print('lowlandKappa2019', lowlandConfusionMatrix2019.kappa());
...
Map.addLayer(validationSample2020, {}, 'samples2020');
...
var uplandSample2020 = validationSample2020.filter(ee.Filter.and(ee.Filter.gte('elevation', 700), ee.Filter.lt('elevation', 1600)));
print('uplandSample2020', uplandSample2020);

Map.addLayer(uplandSample2020, {}, 'uplandSample2020');

var uplandConfusionMatrix2020 = uplandSample2020.errorMatrix(property, 'classification');
print('uplandConfusionMatrix2020', uplandConfusionMatrix2020);
print('uplandAccuracy2020', uplandConfusionMatrix2020.accuracy());
print('uplandConsumersAccuracy2020 (Precision)', uplandConfusionMatrix2020.consumersAccuracy().get([0, 1]));
print('uplandProducersAccuracy2020 (Recall)', uplandConfusionMatrix2020.producersAccuracy().get([1, 0]));
print('uplandFscore2020', uplandConfusionMatrix2020.fscore().get([1]));
print('uplandKappa2020', uplandConfusionMatrix2020.kappa());

print('##########################################');
print('lowland validation');
print('##########################################');

var lowlandSample2020 = validationSample2020.filter(ee.Filter.and(ee.Filter.gte('elevation', 200), ee.Filter.lt('elevation', 700)));
print('lowlandSample2020', lowlandSample2020);

Map.addLayer(lowlandSample2020, {}, 'lowlandSample2020');

var lowlandConfusionMatrix2020 = lowlandSample2020.errorMatrix(property, 'classification');
print('lowlandConfusionMatrix2020', lowlandConfusionMatrix2020);
print('lowlandAccuracy2020', lowlandConfusionMatrix2020.accuracy());
print('lowlandConsumersAccuracy2020 (Precision)', lowlandConfusionMatrix2020.consumersAccuracy().get([0, 1]));
print('lowlandProducersAccuracy2020 (Recall)', lowlandConfusionMatrix2020.producersAccuracy().get([1, 0]));
print('lowlandFscore2020', lowlandConfusionMatrix2020.fscore().get([1]));
print('lowlandKappa2020', lowlandConfusionMatrix2020.kappa());
